...
public abstract class CMSMFMain {
	...
	protected final IDfSession getSession() throws NoSuchElementException, IllegalStateException, Exception {
		return this.connectionPool.borrowObject();
	}

	protected final void closeSession(IDfSession session) {
