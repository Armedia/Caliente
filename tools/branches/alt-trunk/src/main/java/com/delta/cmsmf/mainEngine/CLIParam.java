...
public enum CLIParam {
	...
	log4j(null, true, "The Log4j configuration (XML format) to use instead of the default (overrides --log-name)"),
	log_name(null, true, "The log name to use instead of the default"),
