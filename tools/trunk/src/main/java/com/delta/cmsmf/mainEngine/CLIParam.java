...
public enum CLIParam {
	...
	cabinet_name(CMSMFProperties.STATE_CABINET_NAME, true,
		"The Cabinet where CMSMF state will be stored (CMSMF_SYNC is the default)"),
	post_process(CMSMFProperties.POST_PROCESS_IMPORT, false, "Whether to post-process the imported content"),
	predicate(CMSMFProperties.EXPORT_PREDICATE, true, "The DQL 'from-where' clauses to use for ad-hoc exports"),
