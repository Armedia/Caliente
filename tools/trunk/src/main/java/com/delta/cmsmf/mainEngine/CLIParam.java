...
public enum CLIParam {
	...
	special_users(Setting.SPECIAL_USERS, true, "The special users that should not be imported into the target instance"),
	special_groups(Setting.SPECIAL_GROUPS, true,
		"The special users that should not be imported into the target instance"),
	special_types(Setting.SPECIAL_TYPES, true, "The special types that should not be imported into the target instance"),
