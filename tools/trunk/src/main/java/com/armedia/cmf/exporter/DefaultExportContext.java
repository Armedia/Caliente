 ...
 *
 */
public class DefaultExportContext<S, V> extends DefaultTransferContext<S, V> implements ExportListener {
	 ...
	 * @param output
	 */
	public DefaultExportContext(ObjectStorageTranslator<V> translator, String rootId, S session,
