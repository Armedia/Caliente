...
// "DM_ENCR_PASS=k5B43znDAL0Jnej4wBcYEYKOe4te080xbb4rdoQMTkRk1joXWgNzcUhgWJnbvD55")).getSession();
		...
		DctmObjectExportHelper.serializeFormatByName(dctmSession, "skm_format1");
		...
		while (dctmObject != null) {
			...
			// add 1 at the end of format name
			String formatName = dctmObject.getStrSingleAttrValue(DctmAttrNameConstants.NAME) + "1";
