...
public class CalienteTransformationOptions extends Options {
	...
	public CalienteTransformationOptions() {
		this.group = new OptionGroupImpl("Common URL Options") //
			.add(CalienteTransformationOptions.URL) //
			.add(CalienteTransformationOptions.USER) //
			.add(CalienteTransformationOptions.PASSWORD) //
			.add(CalienteTransformationOptions.DOMAIN) //
		;
	}
