...
public class LocalImportContext extends ImportContext<LocalRoot, CmfValue, LocalImportContextFactory> {
	...
	public LocalImportContext(LocalImportContextFactory factory, CfgTools settings, String rootId, CmfObject.Archetype rootType,
		LocalRoot session, Logger output, WarningTracker warningTracker, Transformer transformer,
