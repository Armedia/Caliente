...
public class UcmImportContext extends ImportContext<IdcSession, CmfValue, UcmImportContextFactory> {

	UcmImportContext(UcmImportContextFactory factory, String rootId, CmfType rootType, IdcSession session,
		Logger output, WarningTracker warningTracker, CmfTypeMapper typeMapper,
