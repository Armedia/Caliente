...
public final class SqlRoot implements Comparable<SqlRoot> {
	...
	public SqlRoot(File path) throws IOException {
		this(path.getCanonicalPath());
	}

	public SqlRoot(String path) throws IOException {
		this.file = new File(SqlRoot.normalize(path)).getCanonicalFile();
	...
	public String relativize(String path) throws IOException {
		File f = new File(SqlRoot.normalize(path));
		if (!f.isAbsolute()) {
	...
	public File makeAbsolute(String path) throws IOException {
		return new File(this.file, SqlRoot.normalize(path)).getAbsoluteFile();
	}
	...
	public boolean equals(Object obj) {
		...
		SqlRoot other = SqlRoot.class.cast(obj);
		if (!Objects.equals(this.file, other.file)) { return false; }
		return true;
	}

	@Override
	public int compareTo(SqlRoot o) {
		if (o == null) { return 1; }
	...
	public String toString() {
		return String.format("SqlRoot [%s]", this.file);
	}
}