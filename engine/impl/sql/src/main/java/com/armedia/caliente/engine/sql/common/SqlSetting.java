...
public enum SqlSetting implements TransferEngineSetting {
	//
	...
	private SqlSetting(CmfValue.Type type) {
		this(type, null);
	}

	private SqlSetting(CmfValue.Type type, Object defaultValue) {
		this(type, defaultValue, false);
	}

	private SqlSetting(CmfValue.Type type, Object defaultValue, boolean required) {
