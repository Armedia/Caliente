...
public class SqlFolderImportDelegate extends SqlImportDelegate {

	protected SqlFolderImportDelegate(SqlImportDelegateFactory factory, CmfObject<CmfValue> storedObject)
		throws Exception {
