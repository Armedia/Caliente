...
public class SqlImportContext extends ImportContext<SqlRoot, CmfValue, SqlImportContextFactory> {

	public SqlImportContext(SqlImportContextFactory factory, CfgTools settings, String rootId,
