...
public class SqlImportContextFactory extends
	ImportContextFactory<SqlRoot, SqlSessionWrapper, CmfValue, SqlImportContext, SqlImportEngine, File> {

	protected SqlImportContextFactory(SqlImportEngine engine, CfgTools settings, SqlRoot root,
	...
	@Override
	protected File locateFolder(SqlRoot session, String path) throws Exception {
	...
	@Override
	protected File createFolder(SqlRoot session, File parent, String name) throws Exception {
	...
	@Override
	protected SqlImportContext constructContext(String rootId, CmfObject.Archetype rootType, SqlRoot session,
		int historyPosition) {
		return new SqlImportContext(this, getSettings(), rootId, rootType, session, getOutput(), getWarningTracker(),
