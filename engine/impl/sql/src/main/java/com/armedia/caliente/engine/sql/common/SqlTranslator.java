...
public class SqlTranslator extends CmfAttributeTranslator<CmfValue> {
	...
	private static final CmfAttributeNameMapper MAPPER = new CmfAttributeNameMapper() {
		...
		public String encodeAttributeName(CmfObject.Archetype type, String attributeName) {
			BidiMap<String, IntermediateAttribute> mappings = SqlTranslator.getAttributeMappings(type);
			if (mappings != null) {
