...
public class LocalImportContext extends ImportContext<RootPath, StoredValue> {

	public LocalImportContext(LocalImportContextFactory factory, CfgTools settings, String rootId,
		StoredObjectType rootType, RootPath session, Logger output, ObjectStorageTranslator<StoredValue> translator,
