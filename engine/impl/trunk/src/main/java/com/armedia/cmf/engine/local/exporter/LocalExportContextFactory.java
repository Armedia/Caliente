...
public class LocalExportContextFactory extends
	ExportContextFactory<RootPath, LocalSessionWrapper, StoredValue, LocalExportContext, LocalExportEngine> {
	...
	@Override
	protected LocalExportContext constructContext(String rootId, StoredObjectType rootType, RootPath session,
