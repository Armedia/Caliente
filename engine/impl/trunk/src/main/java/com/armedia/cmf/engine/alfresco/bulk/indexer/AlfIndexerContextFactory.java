...
public class AlfIndexerContextFactory
	extends ImportContextFactory<AlfRoot, AlfSessionWrapper, CmfValue, AlfIndexerContext, AlfIndexerEngine, File> {

	protected AlfIndexerContextFactory(AlfIndexerEngine engine, CfgTools settings, AlfRoot root) throws Exception {
	...
	@Override
	protected AlfIndexerContext constructContext(String rootId, CmfType rootType, AlfRoot session, Logger output,
		CmfObjectStore<?, ?> objectStore, CmfContentStore<?, ?, ?> contentStore, CmfTypeMapper typeMapper,
		int batchPosition) {
		return new AlfIndexerContext(this, getSettings(), rootId, rootType, session, output, typeMapper,
