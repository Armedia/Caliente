...
public class DctmImportSysObject<T extends IDfSysObject> extends DctmImportAbstract<T> {

	protected DctmImportSysObject(DctmImportEngine engine, DctmObjectType type) {
		super(engine, type);
	}
