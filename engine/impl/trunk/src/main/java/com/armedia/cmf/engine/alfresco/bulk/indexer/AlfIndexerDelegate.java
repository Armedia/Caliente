...
public abstract class AlfIndexerDelegate extends
	ImportDelegate<File, AlfRoot, AlfSessionWrapper, CmfValue, AlfIndexerContext, AlfIndexerDelegateFactory, AlfIndexerEngine> {
	...
	protected AlfIndexerDelegate(AlfIndexerDelegateFactory factory, CmfObject<CmfValue> storedObject) throws Exception {
