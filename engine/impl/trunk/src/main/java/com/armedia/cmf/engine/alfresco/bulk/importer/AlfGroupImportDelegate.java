...
import com.armedia.cmf.engine.alfresco.bulk.importer.jaxb.GroupT;
...
public class AlfGroupImportDelegate extends AlfAggregatedImportDelegate<GroupT, GroupsT> {

	protected AlfGroupImportDelegate(AlfImportDelegateFactory factory, CmfObject<CmfValue> storedObject)
		throws Exception {
		super(factory, storedObject, GroupsT.class);
	}

	@Override
	protected GroupT createItem(CmfAttributeTranslator<CmfValue> translator, AlfImportContext ctx)
