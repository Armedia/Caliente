...
public class AlfIndexerContext extends ImportContext<AlfRoot, CmfValue, AlfIndexerContextFactory> {

	public AlfIndexerContext(AlfIndexerContextFactory factory, CfgTools settings, String rootId, CmfType rootType,
