...
public interface DctmACL {
	...
	public static final String ACCESSOR_TYPES = "accessorTypes";
	public static final String PERMIT_TYPES = "permitTypes";
	public static final String PERMIT_VALUES = "permitValues";
