/*******************************************************************************
 * #%L Armedia Caliente %% Copyright (C) 2013 - 2019 Armedia, LLC %% This file is part of the
 * Caliente software.
 *
 ...
 *******************************************************************************/
@javax.xml.bind.annotation.XmlSchema(namespace = com.armedia.caliente.engine.tools.xml.ObjectFactory.NAMESPACE, elementFormDefault = javax.xml.bind.annotation.XmlNsForm.QUALIFIED, xmlns = {
	@XmlNs(prefix = "", namespaceURI = com.armedia.caliente.engine.tools.xml.ObjectFactory.NAMESPACE)
})
