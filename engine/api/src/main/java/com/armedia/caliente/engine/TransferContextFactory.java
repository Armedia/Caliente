...
> {
	...
	private static CmfArchetype decodeObjectType(Object o) {
		if (o == null) { return null; }
		if (o instanceof CmfArchetype) { return CmfArchetype.class.cast(o); }
		if (o instanceof String) {
			try {
				return CmfArchetype.valueOf(String.valueOf(o));
	...
	private final Set<CmfArchetype> excludes;
	...
	protected TransferContextFactory(ENGINE engine, CfgTools settings, SESSION session,
		...
		Set<CmfArchetype> excludes = EnumSet.noneOf(CmfArchetype.class);
		for (Object o : settings.getObjects(TransferSetting.EXCLUDE_TYPES)) {
			CmfArchetype t = TransferContextFactory.decodeObjectType(o);
			if (t != null) {
				excludes.add(t);
			}
		}
	...
	public final CONTEXT newContext(String rootId, CmfArchetype rootType, SESSION session, int batchPosition) {
	...
	protected abstract CONTEXT constructContext(String rootId, CmfArchetype rootType, SESSION session, int batchPosition);
