...
> extends TransferContext<SESSION, VALUE, CONTEXT_FACTORY> {
	...
	public ImportContext(CONTEXT_FACTORY factory, CfgTools settings, String rootId, CmfArchetype rootType, SESSION session,
	...
	public final int loadObjects(CmfArchetype type, Set<String> ids, final CmfObjectHandler<VALUE> handler)
