...
public abstract class CmfValueMapper {
	...
	public static final class Mapping {
		...
		private Mapping(CmfArchetype objectType, String mappingName, String sourceValue, String targetValue) {
	 ...
	 */
	protected final Mapping newMapping(CmfArchetype objectType, String mappingName, String sourceValue, String targetValue) {
	...
	public final void clearTargetMapping(CmfArchetype objectType, String mappingName, String sourceValue) {
		setMapping(objectType, mappingName, sourceValue, null);
	}

	public final void clearSourceMapping(CmfArchetype objectType, String mappingName, String targetValue) {
	...
	public final Mapping setMapping(CmfArchetype objectType, String mappingName, String sourceValue, String targetValue) {
		if (objectType == null) { throw new IllegalArgumentException("Must provide an object type"); }
		if (mappingName == null) { throw new IllegalArgumentException("Must provide a mapping name"); }
	 ...
	 */
	protected abstract Mapping createMapping(CmfArchetype objectType, String mappingName, String sourceValue,
		String targetValue);
	 ...
	 * {@link #getSourceMapping(CmfArchetype, String, String)}.
	 * </p>
	 *
	 * @param objectType
	 * @param mappingName
	 ...
	 */
	public abstract Mapping getTargetMapping(CmfArchetype objectType, String mappingName, String sourceValue);

	/**
	 * <p>
	 * Retrieves the value mapping for the given object type, name and target value, or {@code null}
	 * if no such mapping can be found. This operation is the reverse of
	 * {@link #getTargetMapping(CmfArchetype, String, String)}
	 * </p>
	 *
	 * @param objectType
	 * @param mappingName
	 ...
	 */
	public abstract Collection<Mapping> getSourceMapping(CmfArchetype objectType, String mappingName, String targetValue);
	 ...
	 */
	public abstract Map<CmfArchetype, Set<String>> getAvailableMappings();
	 ...
	 */
	public abstract Set<String> getAvailableMappings(CmfArchetype objectType);
	 ...
	 */
	public abstract Map<String, String> getMappings(CmfArchetype objectType, String mappingName);
}